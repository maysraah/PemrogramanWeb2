            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <a href="{{ route('sepatu.create') }}" class="btn btn-success">Tambah Data</a>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->gambar }}</td>
                                    <td>
                                        <a href="{{ route('sepatu.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                        <form action="{{ route('sepatu.destroy',$item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
